...
<footer class="bg-dark position-relative overflow-hidden pt-6" data-bs-theme="dark">
	...
	<div class="position-absolute top-0 end-0 mt-n3 me-n4">
		<img src="{{ asset('frontend/assets/images/elements/decoration-pattern-2.svg')}}" style="opacity:0.05;" alt="">
	</div>
	...
	<div class="container position-relative mt-5">
					...
					<div class="col-md-4">
						...
						<div class="row g-2 mt-2 mb-4 mb-sm-5">
							...
							<div class="col-5 col-sm-4 col-md-6">
								<a href="#"> <img src="{{ asset('frontend/assets/images/elements/google-play.svg') }}" alt=""> </a>
							</div>
							<!-- App store button -->
							<div class="col-5 col-sm-4 col-md-6">
								<a href="#"> <img src="{{ asset('frontend/assets/images/elements/app-store.svg') }}" alt="app-store"> </a>
							</div>
						</div>
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
			<!-- copyright text -->
			<div class="text-body"> Copyrights ©2024 Mizzle. Build by <a href="../www.webestica.com/index.html" class="text-body text-primary-hover">Webestica</a>. </div>
			<!-- copyright links-->
			<!-- Language selector -->
			<div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
				...
				<ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
					<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/images/flags/uk.svg')}}" alt="">English</a></li>
					<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/images/flags/gr.svg')}}" alt="">German </a></li>
					<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="{{ asset('frontend/assets/images/flags/sp.svg')}}" alt="">French</a></li>
				</ul>
			</div>
		</div>
	</div>
